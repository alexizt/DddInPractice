...
namespace DddInPractice.Tests
{
    public class MoneySpecs
    {
        ...
        public void Two_money_instances_do_not_equal_if_contain_different_money_amount()
        {
            ...
            // In our model 100 Cents are different than 1 dollar
            ...
            int twentyDollarCount)
        {
            ...
            Exception ex = Assert.Throws<InvalidOperationException>(action);
            //action.T<InvalidOperationException>();
        }
        ...
        public void Substraction_of_two_moneys_produces_correct_result() {
            ...
            sum.QuarterCentCount.Should().Be(7);
            ...
            string expectedAmount)
                {
                    ...
                    money.ToString().Should().Be(expectedAmount);
        }
    }
}
